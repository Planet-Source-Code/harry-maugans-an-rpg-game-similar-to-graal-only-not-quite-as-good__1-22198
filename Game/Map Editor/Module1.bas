...
Public Function Init()
    ...
    ScaleH = frmMain.MapHeight
    ScaleW = frmMain.MapWidth
    
    frmMain.TotalMapData = Mid(frmMain.TotalMapData, 1, Len(frmMain.TotalMapData) - 1)
    ...
    Do Until i = ScaleH
        ...
        Do Until j = ScaleW
            ...
            If Num = 1 Or Num = 4 Or Num = 5 Or Num = 7 Or Num = 15 Or Num = 16 Or Num = 17 Or Num = 18 Or Num = 19 Or Num = 20 Or Num = 21 Or Num = 22 Or Num = 23 Or Num = 24 Or Num = 25 Or Num = 26 Or Num = 27 Or Num = 28 Then
...
Public Function ClearMapBoxes()
    ...
    For i = 1 To frmMain.MapBoxes.Count
        frmMain.MapBoxes.Remove 1
    Next i
